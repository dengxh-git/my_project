 ...
 <body>
        <div id="dataform1" style="padding-top:5px;">
            <table class="nui-form-table">
                <tr>
                    ...
                    <td colspan="1">
                        <input class="nui-buttonedit searchbox" name="comuser.usercd" allowinput="false"  textName="comuser.usercd"
        ...
        <script type="text/javascript">
            ...
            function saveData(){
                ...
                //保存
                var urlStr = "com.sunline.sunfi.sunfi_cm.comuserbiz.addComUser.biz.ext";
                form.validate();
