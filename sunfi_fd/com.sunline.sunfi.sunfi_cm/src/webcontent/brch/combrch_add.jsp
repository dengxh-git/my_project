...
- Description:
    ...
    <body>        
        <div id="dataform1" style="padding-top:5px;">
            <table class="nui-form-table">
                ...
                <tr>
                    ...
                    <td>
                        <input class="nui-buttonedit searchbox"  id="combrch.sprrcd" onbuttonclick="selectBrch" allowInput="false" name="combrch.sprrcd" textName="brchna"/>
        ...
        <script type="text/javascript">
            ...
            var brchtp = '${brchtp}';
            if(brchtp !=null && brchtp !=""){
             nui.get("combrch.brchtp").setValue(brchtp);
                ...
                //设置机构序列
			     ...
			     var json = nui.encode({template:data});			        		
			                    ...
			                    success: function (text) {
			                       var o = nui.decode(text);
			                        if(o.data == "1"){
						                ...
						                $.ajax({
						                    url:"com.sunline.sunfi.sunfi_cm.combrchbiz.addComBrch.biz.ext",
						                    type:'POST',
						                    data:json,
						                    cache:false,
						                    contentType:'text/json',
			       ...
			       function selectBrch(e) {
			        var btnEdit = this;
			        var sigValue=encryptByDES("0000");	
			        nui.open({
			            url: "<%=request.getContextPath() %>/sunfi_cm/brch/combrch_select_by_not_power.jsp?brchtp=0000&&sig="+sigValue,
			            showMaxButton: false,
			            title: "选择上级机构",
			            width: 950,
			            height: 600,
