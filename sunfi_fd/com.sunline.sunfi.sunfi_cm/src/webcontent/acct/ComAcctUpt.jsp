   ...
   <div id="dataform1" style="padding-top:5px;">
         <table class="nui-form-table">
                <tr>
                    ...
                    <td colspan="1">
                        <input class="nui-textbox" name="comacct.acctno" required="true" enabled="enabled"/>
                    </td>
                    <td class="nui-form-table-text">
                        付款账号名称:
                    </td>
                ...
                <tr>
                    ...
                    <td colspan="1">
                        <input class="nui-buttonedit searchbox" onbuttonclick="selectItem" allowInput="false" id="comacct.itemcd" name="comacct.itemcd" textName="comacct.itemna" allowInput="false"/>
                    </td>
                    <td class="nui-form-table-text">
                        所属机构:
                    </td>
                    <td colspan="1">
                        <input class="nui-buttonedit searchbox" onbuttonclick="selectBrch" allowInput="false" id="comacct.brchcd" name="comacct.brchcd" textName="comacct.brchna" allowInput="false" />
                    </td>
                </tr>
                <tr>
                    <td class="nui-form-table-text">
                    ...
                    <td colspan="1">
                        <input class="nui-buttonedit searchbox" onbuttonclick="selectDuty" allowInput="false" id="comacct.dutycd" name="comacct.dutycd" textName="comacct.dutyna" allowInput="false" />
                    </td>
                    <!-- <td class="form_label">
                        开户银行:
                    </td>
                    ...
                    <td colspan="1">
                        <input class="nui-buttonedit searchbox" onbuttonclick="selectBank" allowInput="false" id="comacct.brname" name="comacct.brname" textName="comacct.brname" allowInput="false" />
                    </td>
                </tr>
                <tr>                   
                    <td class="nui-form-table-text">
	...
	<script type="text/javascript">
    	...
    	function saveData(){
                ...
                $.ajax({
			        url: "com.sunline.sunfi.sunfi_cm.comacctbiz.checkIsAcctUpt.biz.ext",
			        type: 'POST',
				    data: json,
                ...
                $.ajax({
                    url:"com.sunline.sunfi.sunfi_cm.comacctbiz.uptComAcct.biz.ext",
                    type:'POST',
                    data:json,
                    cache:false,
                    contentType:'text/json',
                    ...
                    function setData(data){
                      ...
                      data = nui.clone(data);
                      //如果是点击编辑类型页面              
                   	  var json = nui.encode({comacct:data});
                   	
                    $.ajax({
                    url: "com.sunline.sunfi.sunfi_cm.comacctbiz.getComAcct.biz.ext",
                    type: 'POST',
	                data: json,
	                contentType:'text/json',
                    cache: false,
