...
- Description:
    ...
    <body>
        ...
        <div id="dataform1" style="padding-top:5px;">
            <!-- hidden域 -->
            <input class="nui-hidden" name="eqddcmtbrch.brchcd" />
            <input class="nui-hidden" name="eqddcmtbrch.usercd" />
            <input class="nui-hidden" name="eqddcmtbrch.bsnssq" />
            <input class="nui-hidden" name="eqddcmtbrch.bsnsdt" />
            <input class="nui-hidden" name="eqddcmtbrch.wkflid" value=""/>
            <input class="nui-hidden" name="eqddcmtbrch.transt" />
