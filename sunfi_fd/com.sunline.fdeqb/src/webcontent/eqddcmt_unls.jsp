...
<fieldset style="width:700px;border:solid 1px #aaa;position:relative;">
	...
	<div id="editForm1" style="padding-top: 5px;" align="center">
		...
		<!-- 流程id -->
		<input class='nui-hidden' name="master.prcscd" value="eqd_dct_uls">
		<table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
			...
			<tr>
				...
				<td colspan="1" align="left"><input class="nui-textbox" name="master.lossdt" readOnly="true"/></td>
			...
			<tr>
				<td class="form_label"  align="right">解挂日期:</td>
				<td colspan="1" align="left"><input name="master.unlsdt" class="nui-datepicker" format="yyyyMMdd"  value="new Date();"/></td>
				<td class="form_label"  align="right">解挂原因:</td>
				<td colspan="1" align="left"><input class="nui-textbox" name="master.unlsrs" required="true"/></td>
			</tr>
		</table>
	</div>
	...
	<script type="text/javascript">
		...
		//nui.getbyName("master.unlsdt").setValue(nui.formatDate(new Date(),'yyyyMMdd'));
		
		function onButtonEdit(e) {
			var btnEdit = this;
		    nui.open({
			    url: bootPath+"/fdeqb/eqddcmtdetls_query.jsp?dcmtst=2,6",
			    title: "选择列表",
			    width: 650,
			    height: 380,
			        ...
			        if (action == "ok") {
			            ...
			            data = nui.clone(data);    //必须
			 			if (data) {
			            	...
			            	nui.getbyName("master.lossdt").setValue(data.lossdt);
			 			}
			        }
			    }
			});
		...
		function onSave(){
			...
			data.master.unlsdt = nui.getbyName("master.unlsdt").getFormValue();
