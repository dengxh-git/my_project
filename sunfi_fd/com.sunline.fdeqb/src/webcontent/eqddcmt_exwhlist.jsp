...
- Description:
    ...
    <body style="width:98%;height:95%;">
        <div class="nui-panel" title="未领取股权证查询" iconCls="icon-add" style="width:100%;height:15%;" showToolbar="false" showFooter="true">
            <div id="form1" class="nui-form" align="center" style="height:100%">
                ...
                <input class="nui-hidden" name="criteria/_expr[4]/status" value="0"/>
                <input class="nui-hidden" name="criteria/_expr[4]/_op" value="=">
                <table id="table1" class="table" style="height:100%">
                    <tr>
                        <td class="form_label">  起始号码:</td>
                        <td colspan="1">
        ...
        <div class="nui-panel" title="股权证登记列表" iconCls="icon-add" style="width:100%;height:85%;" showToolbar="false" showFooter="false" >
            <div class="nui-toolbar" style="border-bottom:0;padding:0px;">
                <table style="width:100%;">
                    <tr>
                        <td style="width:100%;">
                            <a class="nui-button" iconCls="icon-add" onclick="edit()">领取</a>
                        </td>
                    </tr>
                </table>
            </div>
            <div class="nui-fit">
                <div id="datagrid1" dataField="eqddcmtbrchs" class="nui-datagrid" style="width:100%;height:100%;" url="com.sunline.fdeqb.eqddcmtbrchbiz.queryEqdDcmtBrchs.biz.ext" pageSize="10" showPageInfo="true" multiSelect="true"  allowSortColumn="false">
                    <div property="columns">
                        <div type="indexcolumn">
                        </div>
                        <div type="checkcolumn">
                        </div>
                        <div field="dcmtid" headerAlign="center" allowSort="true" >凭证序号</div>
                        <div field="prefno" headerAlign="center" allowSort="true" >编码前缀</div>
                        <div field="initno" headerAlign="center" allowSort="true" >起始号码</div>
                        <div field="finlno" headerAlign="center" allowSort="true" >结束号码</div>
                        <div field="tranam" headerAlign="center" allowSort="true" >份数</div>
                        <div field="regtdt" headerAlign="center" allowSort="true" >登记日期</div>
                        <div field="brchcd" headerAlign="center" allowSort="true" >凭证所属机构</div>
        ...
        <script type="text/javascript">
            ...
            function edit() {
                ...
                if (row) {
                    nui.open({
                        url: bootPath+"/fdeqb/eqddcmt_exwarehouse.jsp",
                        title: "编辑数据",
                        width: 650,
                        height: 400,
                        onload: function () {
