...
<html>
  ...
  <body style="width:100%;overflow:hidden;">
  	 <form id="form1" method="post">
        ...
        <input name="detail.bsnsdt" class="mini-hidden"/>
        <input name="detail.bsnssq" class="mini-hidden"/>
        ...
        <input name="master.cityno" class="mini-hidden" value=""/>
        <input name="master.prcscd" class="mini-hidden" value="<%=addprcscd %>"/>
        <input name="detail.ismain" class="mini-hidden" value="0"/>
        <input name="detail.calPrcscd" class="mini-hidden" value="eqb_com_cal"/>
        <input name="detail.addPrcscd" class="mini-hidden" value="<%=addprcscd %>"/>
        <input name="detail.enterPrcscd" class="mini-hidden" value="<%=entprcscd %>"/>
        <input name="master.lnkurl" class="mini-hidden" value="/sunfi_eq/EqbPldgQuery.jsp?opratp=${opratp}&wkflid="/>
        <input name="detail.lnkurl" class="mini-hidden" value="/sunfi_eq/EqbPldgQuery.jsp?opratp=${opratp}&wkflid="/>
           ...
           <div style="padding:5px;">
	            <table style="table-layout:fixed;">
	                ...
	                <tr>
				        ...
				        <td style="width:150px;">
				          	<input class="nui-textbox " name="detail.h_froznm" allowInput="false" required="true" emptyText="0" vtype="int"/>
				        </td> 
	                	<td style="width:100px;">历史<%=obj_froznm %>：</td>
				        <td style="width:150px;">
				          	<input class="nui-textbox " name="detail.h_pldgnm" allowInput="false" required="true" emptyText="0" vtype="int"/>
				        </td>
	                ...
	                <tr>
				        ...
				        <td style="width:150px;">
				        	<input class="nui-datepicker " name="detail.unpldt" allowInput="false" required="true" />
				        </td>
	                </tr>
	                <tr>
				        ...
				        <td style="width:150px;">
				            <input class="nui-textbox " name="detail.remark" />
				        </td>
	                </tr>
	            </table>
             </div>
        ...
        <div style="text-align:center;padding:10px;">               
            ...
            <a class="mini-button" onclick="onOkAndSubmit()">保存并提交</a>   
  ...
  <script type="text/javascript">
    ...
    function saveData(){
      ...
      var unpldt=nui.getbyName("detail.unpldt").getValue();
      ...
      $.ajax({
        ...
        success:function(text){
			...
			if(returnJson.exception == null){
				...
				nui.alert("保存<%=obj %>失败", "系统提示", function(action){
					if(action == "ok" || action == "close"){
    ...
    function dataCheck(){
    	if(nui.getbyName("detail.pldgdt").getValue() > nui.getbyName("detail.unpldt").getValue()){
			if(opratp == "19"){
        ...
        var thisam=new Number(nui.getbyName("detail.thisam").getValue());
       
        var stcknm=new Number(nui.getbyName("detail.stcknm").getValue());//持股数
          
    	var froznm=new Number(nui.getbyName("detail.h_froznm").getValue());//历史冻结股数
    	var pldgnm=new Number(nui.getbyName("detail.h_pldgnm").getValue());//历史质押股数
		                    ...
		                    if (data) {
								...
								$.ajax({
			                        ...
			                        success:function(text){
				                            ...
				                            if(returnJson.exception == null){
				                            	//if(opratp=='19'){//质押
												   nui.getbyName("detail.h_froznm").setValue(returnJson.froznm);
												   
												   nui.getbyName("detail.h_pldgnm").setValue(returnJson.pldgnm);
												/*  }else{//冻结
