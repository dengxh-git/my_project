...
- Date: 2019-05-13 9:40:13
- Description:
--%>
<%
		//获取标签中使用的国际化资源信息
		String obj = ""; //
		String pldgnm_frzenm="";
		String pldgst="";
		String frozst="";
	    ...
	    if("20".equals(opratp)){
			...
			pldgnm_frzenm= com.eos.foundation.eoscommon.ResourcesMessageUtil.getI18nResourceMessage("sunfi.sunfi_eq.eqbpldg_slupldgnm"); //解质押股数
			pldgst = com.eos.foundation.eoscommon.ResourcesMessageUtil.getI18nResourceMessage("sunfi.sunfi_eq.eqb_book.pldgst"); //质押状态
		}
			...
			pldgnm_frzenm= com.eos.foundation.eoscommon.ResourcesMessageUtil.getI18nResourceMessage("sunfi.sunfi_eq.eqbpldg_slufrzenm"); //解冻结股数
			frozst = com.eos.foundation.eoscommon.ResourcesMessageUtil.getI18nResourceMessage("sunfi.sunfi_eq.eqb_book.frozst"); //冻结状态
...
<div class="search-condition">
  ...
  <script>
    ...
    function add(){
       nui.open({
          url:"<%=request.getContextPath() %>"+"/sunfi_eq/EqbPldgMemove.jsp?opratp="+opratp,
          title: '<%=obj %>'+'_新增',
          width:800,
          height:600,
          onload:function(){
