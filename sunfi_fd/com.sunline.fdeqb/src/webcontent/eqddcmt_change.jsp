...
<fieldset style="width:700px;border:solid 1px #aaa;position:relative;">
	...
	<div id="editForm1" style="padding-top: 5px;" align="center">
		...
		<!-- 流程id -->
		<input class='nui-hidden' name="master.prcscd" value="eqd_dct_chg">
		<table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
			<tr>
				<td class="form_label" align="right">股权证编号:</td>
				<td colspan="1" align="left">
		         	<input name="master.dcmtno" class="nui-buttonedit" onbuttonclick="onButtonEditDcmtno"/>
		        </td>
				<td class="form_label" align="right">凭证状态:</td>
				<td colspan="1" align="left">
				 	<input class="nui-dictcombobox nui-form-input" name="master.dcmtst" value="1" disabled="true"  readOnly="true"
			...
			<tr>
				<td class="form_label"  align="right">新股权证编号:</td>
				<td colspan="1" align="left"><input name="master.todcno" class="nui-buttonedit" onbuttonclick="onButtonEditTodcno"/></td>
				<td class="form_label"  align="right">凭证状态:</td>
				<td colspan="1" align="left">
					<input class="nui-dictcombobox nui-form-input" name="master.todcst" value="0"  readOnly="true"
          			valueField="dictID" textField="dictName" dictTypeId="FI_DCMTST"/>
          		</td>
			</tr>
			<tr>
				<td class="form_label"  align="right">变更日期:</td>
				<td colspan="1" align="left"><input name="master.chgedt" class="nui-datepicker" format="yyyyMMdd" value="new Date();"/></td>
				<td class="form_label"  align="right">变更原因:</td>
				<td colspan="1" align="left"><input class="nui-textbox" name="master.chgers" /></td>
			</tr>
		</table>
	</div>
	...
	<script type="text/javascript">
		...
		function onButtonEditDcmtno(e) {
			var btnEdit = this;
		    nui.open({
			    url: bootPath+"/fdeqb/eqddcmtdetls_query.jsp",
			    title: "选择列表",
			    width: 650,
			    height: 380,
			        ...
			        if (action == "ok") {
			            ...
			            data = nui.clone(data);    //必须
			 			if (data) {
				 			btnEdit.setValue(data.dcmtno);
				            btnEdit.setText(data.dcmtno);
				            nui.getbyName("master.todcst").setValue(data.dcmtst);
			 			}
			        }
			    }
			});
		...
		function onSave(){
			...
			data.master.chgedt = nui.getbyName("master.chgedt").getFormValue(); //日期需要特殊处理
