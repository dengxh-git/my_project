...
<body>
		...
		<div id="editForm1" style="padding-top: 5px;" align="center">
			...
			<table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
				...
				<tr>
					...
					<td colspan="1" align="left"><input class="nui-textbox" name="master.telpno"  /></td>
				</tr>
				<tr>
					<td class="form_label"  align="right">证件类型:</td>
					<td colspan="1" align="left">
						<input class="nui-dictcombobox nui-form-input" name="master.idcdtp"  
				...
				<tr>
					...
					<td colspan="1" align="left"><input class="nui-textbox" name="master.bkacno"  /></td>
	          		<td class="form_label"  align="right">账户户名:</td>
					<td colspan="1" align="left"><input class="nui-textbox" name="master.acctna"  /></td>
				</tr>
				<tr>
	...
	<div id="gridPanel" class="nui-panel" title="header" iconCls="icon-add" style="width:600px;height:250px;" 
	showToolbar="true" showCloseButton="true" showHeader="false" bodyStyle="padding:0" borderStyle="border:0">
		...
		<div id="datagrid1" class="nui-datagrid" style="width:100%;height:100%;" borderStyle="border:0" showPageSize="false"
			...
			<div property="columns">
				...
				<div field="grupcd" width="120" headerAlign="center" allowSort="true">股东组代码</div>
				<div field="grupna" width="120" headerAlign="center" allowSort="true">股东组名称</div>
			</div>
		</div>
	</div>
	...
	<script type="text/javascript">
        ...
        function SetData(data) {
            if (data.action == "edit") {
                ...
                //data = nui.clone(data);
                $.ajax({
                    url: "com.sunline.fdeqb.eqpshhbiz.queryEqpShhById.biz.ext" ,
                    data: data,
                    cache: false,
                    success: function (text) {
