    ...
    <body>       
                ...
                <input class="nui-hidden" name="wfconfigure.wfConfigureDetls" id="wfconfigure.wfConfigureDetls"/>
                 <table class="nui-form-table">
                    <tr><td class="nui-form-table-text">
                        ...
                        <td colspan="1"> 
                           <input class="nui-hidden" name="wfconfigure.flowid"/>                         
        ...
        <div style="margin:0px 2px 0px 2px;" >
                    ...
                    <div 
                            ...
                            showPager="false"
                            sortMode="client"
                            url="com.sunline.sunfi.sunfi_wf.wfconfigurebiz.getWfConfigure.biz.ext"
                            dataField="wfConfigureDetls"
                            allowCellEdit="true"
                        ...
                        <div property="columns">
                            ...
                            <div field="fldcid"  align="left" headerAlign="center" width="">
                               流程明细代码                              
                            </div>
                            <div field="wfnode"  align="left" headerAlign="center" width="">
                               流程节点                              
                            </div>
                            <div field="wfrole" displayField="rolena" align="left" headerAlign="center" width="" vtype="required">
                               流程角色
                                <input class="nui-buttonedit" onbuttonclick="selectRole" property="editor" visible="true"/>
                            </div>
                            <div field="flowid" allowSort="true" align="left" headerAlign="center" width="0">
                   流程id                              
                            </div>
                        </div>
                    </div>
        ...
        <script type="text/javascript">
            ...
            function setData(data){
                data = nui.clone(data);
                nui.get("grid_0").load({wfconfigure:data});
                var json = nui.encode({wfconfigure:data});
                $.ajax({
                    url:"com.sunline.sunfi.sunfi_wf.wfconfigurebiz.getWfConfigure.biz.ext",
                    type:'POST',
                    data:json,
                ...
                function saveData(){
                    ...
                    $.ajax({
                        url:"com.sunline.sunfi.sunfi_wf.wfconfigurebiz.updateWfConfigure.biz.ext",
                        type:'POST',
                        data:json,
                        cache:false,
                        contentType:'text/json',
