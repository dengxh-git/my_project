...
public class ThreeDES {
	 ...
	 * 
	 * 轮子密钥为加密的6 轮子密钥，解密的轮子密钥为加密的5 轮子密钥，
	 * 
	 * 解密的第16 轮子密钥为加密的轮子密钥
	 * 
	 * @param source密文
	 ...
	 * 6进制的字符串转换成ASC的字符串
	 * 
	 * 进制的字符串压缩成BCD30313233343536373839414243444546)-->(0123456789ABCDEF)
	 * 
	 * @param hex
	 * 
	 * @return
	 ...
	 * 
	 * PBOC-DES-MAC(16的整数000000000000000)
	 * 
	 * 使用单长密钥DES算法
	 * 
	 * @param key密钥(16byte)
	...
	public static void main(String[] args) throws Exception {
		...
		String masterKey = "01010101010101010101010101010101";

		// 数据

		String data = "0592389fffffffff";

		System.out.println("zhangh:"+DES_3(data, masterKey, 0));
